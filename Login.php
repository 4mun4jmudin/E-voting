...
<body>
		...
		<div class="login-content">
			<form action="" method="POST">
				...
				<div class="input-div one">
					...
					<div class="div">
						<h5>email</h5>
						<input type="email" class="input" name="Email" required placeholder=""><br>
					</div>
				</div>
				<div class="input-div one">
					<div class="i">
					...
					<div class="div">
						...
						<input type="date" name="Tanggal_Lahir" required placeholder=""><br>
					</div>
				</div>
				...
				<a href="admin.php" class="mt-3 d-block text-center">or Admin Login?</a>
				<input type="submit" class="btn" name="submit">
				<button class="btn " onclick="back()">Back</button>
			</form>
			<?php
			if (isset($error_message)) {
				echo "<h5 style='color:red;text-align:center;'>$error_message</h5>";
			}
			?>
		</div>
	...
	if (isset($_POST['submit'])) {
		...
		$select = "select * from register where Email='$Email' and Password='$Password'and Tanggal_Lahir='$TL'";
